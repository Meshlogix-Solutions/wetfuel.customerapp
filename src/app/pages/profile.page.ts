...
<wf-customer-shell title="Account" [subtitle]="profile()?.companyName || 'Customer'" [showNav]="true"><main class="screen-body stack">
...
export class ProfilePage{
  ...
  ionViewWillEnter():void{this.api.getCurrentCustomer().subscribe({next:value=>this.profile.set(value)});this.api.getSites().subscribe({next:sites=>this.siteCount.set(sites.length)});}
