...
export const routes: Routes = [
  ...
  { path: 'order-confirmation', loadComponent: () => import('./pages/order-confirmation.page').then(m => m.OrderConfirmationPage) },
  { path: 'orders', loadComponent: () => import('./pages/orders.page').then(m => m.OrdersPage) },
  { path: 'order-status', loadComponent: () => import('./pages/order-status.page').then(m => m.OrderStatusPage) },
  { path: 'live-tracking', loadComponent: () => import('./pages/live-tracking.page').then(m => m.LiveTrackingPage) },
  { path: 'equipment', loadComponent: () => import('./pages/equipment.page').then(m => m.EquipmentPage) },
  { path: 'equipment-detail', loadComponent: () => import('./pages/equipment-detail.page').then(m => m.EquipmentDetailPage) },
  ...
  { path: 'delivery-detail', loadComponent: () => import('./pages/delivery-detail.page').then(m => m.DeliveryDetailPage) },
